...
if __name__ == "__main__":
    ...
    #[]相当于一个条件
    data2, y2 = ds.make_blobs(N, n_features=2, centers=centers, cluster_std=(1, 2, 5, 1, 5, 2), random_state=2)

    data3 = np.vstack((data[y == 0][:], data[y == 1][:50], data[y == 2][:20], data[y == 3][:5]))

    y3 = np.array([0] * 100 + [1] * 50 + [2] * 20 + 5 * [3])
